...
Interaction Shop : Clic Droit sur les PNJ marchands.
...
### 2. Pour ton fichier `presentation.md`
*(Ce fichier est le plus important pour le jury NSI. Copie tout le bloc ci-dessous)*

```markdown
# Présentation du projet : FLOIOIDE

## Présentation globale
* **Naissance de l’idée** : Créer un jeu "Boss Rush" avec une thématique florale où la survie dépend de la gestion de ressources vitales (eau/énergie).
...
2.  **Gameplay** : Implémentation du moteur de mouvement et du combat à distance.
...
* **État d’avancement** : Le jeu est complet, du menu principal au combat final contre le Boss Arbre (Phases 1 à 3).
